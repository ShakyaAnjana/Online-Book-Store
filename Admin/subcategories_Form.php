    ...
    <div class="container">
        ...
        <form method="POST" action="categories_manage.php">
            ...
            <div class="form-group">
                ...
                <input type="text" id="subcategoryName" name="subcategoryName" placeholder="Enter subcategory name">
                <button type="submit" name="submitSubcategory">Add Subcategory</button>
            </div>
        </form>
